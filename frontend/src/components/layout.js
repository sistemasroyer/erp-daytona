...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'config-categorias', label: 'Categorias', icon: 'bi-tags', href: '/src/pages/configuracion/categorias.html', perm: 'productos:editar' },
      { key: 'config-marcas', label: 'Marcas', icon: 'bi-bookmark', href: '/src/pages/configuracion/marcas.html', perm: 'productos:editar' },
      { key: 'config-unidades', label: 'Unidades de Medida', icon: 'bi-rulers', href: '/src/pages/configuracion/unidades-medida.html', perm: 'productos:editar' },
      { key: 'config-almacenes', label: 'Almacenes', icon: 'bi-building', href: '/src/pages/configuracion/almacenes.html', perm: 'inventario:editar' },
